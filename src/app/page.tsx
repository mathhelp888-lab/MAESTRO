...
export default function Home() {
  ...
  const [architectureDiagram, setArchitectureDiagram] = React.useState<string | null>(null);
  ...
  const handleDownloadPdf = () => {
    ...
    const disclaimer = "This report is generated by an AI assistant based on the MAESTRO framework. AI can make mistakes; always double-check threats and mitigations with a security expert. The architecture diagram is also AI-generated and may be a simplified representation.";
    ...
    if (architectureDiagram) {
      ...
      try {
        ...
        y = addText("Error embedding diagram.", {}, y);
      }
    }
