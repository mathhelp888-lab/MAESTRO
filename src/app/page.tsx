...
export default function Home() {
  ...
  const handleDownloadPdf = async () => {
    ...
    const addText = (text: string, options: any) => {
      ...
      const lines = doc.splitTextToSize(plainText, usableWidth - (textX - margin));
      ...
      doc.text(lines, textX, y, { align: align || 'left' });
      y += textHeight;
    };
    ...
    doc.setFontSize(8);
    doc.text("Developed by:", margin, developedByY);
    ...
    if(executiveSummary) {
      ...
      y+= 6;
      doc.setTextColor(80);
      addText(executiveSummary, { size: 10, markdown: true });
      y += 16;
    }
    ...
    layers.forEach((layer) => {
      ...
      if (layer.status === "pending" || layer.status === 'analyzing') {
        ...
        doc.setTextColor(150);
        addText("Pending AI review...", { size: 10, style: "italic" });
